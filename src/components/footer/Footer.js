            ...
            <div className="narrow">
                <div className={style.top}>
                    ...
                    <div className={style.t3}>
                        <h4>Помощь</h4>
                        <Link to={'document/return'}>Возврат</Link>
                        <Link to={'document/payment_methods'}>Способы оплаты</Link>
                    </div>
                    <div className={style.t4}>
                        <h4>Документы</h4>
                        <Link to={'document/privacy_policy'}>Политика<br/>конфиденциальности</Link>
                        <Link to={'document/terms_of_services'}>Условия<br/>предоставления услуг</Link>
                    </div>
